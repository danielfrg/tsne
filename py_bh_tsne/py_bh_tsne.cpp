/* Generated by Cython 0.17 on Mon Mar 18 12:31:03 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__py_bh_tsne
#define __PYX_HAVE_API__py_bh_tsne
#include "stdio.h"
#include "stdlib.h"
...
/*--- Type declarations ---*/
struct __pyx_obj_10py_bh_tsne__TSNE;
...
/* Module declarations from 'py_bh_tsne' */
static PyTypeObject *__pyx_ptype_10py_bh_tsne__TSNE = 0;
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "py_bh_tsne"
int __pyx_module_is_main_py_bh_tsne = 0;

/* Implementation of 'py_bh_tsne' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static int __pyx_pf_10py_bh_tsne_5_TSNE___cinit__(struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self); /* proto */
static void __pyx_pf_10py_bh_tsne_5_TSNE_2__dealloc__(CYTHON_UNUSED struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_10py_bh_tsne_5_TSNE_4run(struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self, PyObject *__pyx_v_X, PyObject *__pyx_v_N, PyObject *__pyx_v_D, PyObject *__pyx_v_d, PyObject *__pyx_v_perplexity, PyObject *__pyx_v_theta); /* proto */
...
/* Python wrapper */
static int __pyx_pw_10py_bh_tsne_5_TSNE_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_10py_bh_tsne_5_TSNE_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  ...
  __pyx_r = __pyx_pf_10py_bh_tsne_5_TSNE___cinit__(((struct __pyx_obj_10py_bh_tsne__TSNE *)__pyx_v_self));
...
static int __pyx_pf_10py_bh_tsne_5_TSNE___cinit__(struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static void __pyx_pw_10py_bh_tsne_5_TSNE_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_10py_bh_tsne_5_TSNE_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_10py_bh_tsne_5_TSNE_2__dealloc__(((struct __pyx_obj_10py_bh_tsne__TSNE *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
}
...
static void __pyx_pf_10py_bh_tsne_5_TSNE_2__dealloc__(CYTHON_UNUSED struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_10py_bh_tsne_5_TSNE_5run(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10py_bh_tsne_5_TSNE_5run(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("py_bh_tsne._TSNE.run", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10py_bh_tsne_5_TSNE_4run(((struct __pyx_obj_10py_bh_tsne__TSNE *)__pyx_v_self), __pyx_v_X, __pyx_v_N, __pyx_v_D, __pyx_v_d, __pyx_v_perplexity, __pyx_v_theta);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pf_10py_bh_tsne_5_TSNE_4run(struct __pyx_obj_10py_bh_tsne__TSNE *__pyx_v_self, PyObject *__pyx_v_X, PyObject *__pyx_v_N, PyObject *__pyx_v_D, PyObject *__pyx_v_d, PyObject *__pyx_v_perplexity, PyObject *__pyx_v_theta) {
 ...
 */
  ...
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_6 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__float64); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_tp_new_10py_bh_tsne__TSNE(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  if (__pyx_pw_10py_bh_tsne_5_TSNE_1__cinit__(o, __pyx_empty_tuple, NULL) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_10py_bh_tsne__TSNE(PyObject *o) {
  {
    PyObject *etype, *eval, *etb;
    PyErr_Fetch(&etype, &eval, &etb);
    ++Py_REFCNT(o);
    __pyx_pw_10py_bh_tsne_5_TSNE_3__dealloc__(o);
...
static PyMethodDef __pyx_methods_10py_bh_tsne__TSNE[] = {
  {__Pyx_NAMESTR("run"), (PyCFunction)__pyx_pw_10py_bh_tsne_5_TSNE_5run, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};

static PyNumberMethods __pyx_tp_as_number__TSNE = {
  0, /*nb_add*/
  0, /*nb_subtract*/
  0, /*nb_multiply*/
  #if PY_MAJOR_VERSION < 3
...
static PySequenceMethods __pyx_tp_as_sequence__TSNE = {
  0, /*sq_length*/
  0, /*sq_concat*/
  0, /*sq_repeat*/
  0, /*sq_item*/
...
static PyMappingMethods __pyx_tp_as_mapping__TSNE = {
  0, /*mp_length*/
  0, /*mp_subscript*/
  0, /*mp_ass_subscript*/
};

static PyBufferProcs __pyx_tp_as_buffer__TSNE = {
  #if PY_MAJOR_VERSION < 3
  0, /*bf_getreadbuffer*/
  #endif
  #if PY_MAJOR_VERSION < 3
...
static PyTypeObject __pyx_type_10py_bh_tsne__TSNE = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("py_bh_tsne._TSNE"), /*tp_name*/
  sizeof(struct __pyx_obj_10py_bh_tsne__TSNE), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_10py_bh_tsne__TSNE, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  #endif
  0, /*tp_repr*/
  &__pyx_tp_as_number__TSNE, /*tp_as_number*/
  &__pyx_tp_as_sequence__TSNE, /*tp_as_sequence*/
  &__pyx_tp_as_mapping__TSNE, /*tp_as_mapping*/
  0, /*tp_hash*/
  0, /*tp_call*/
  0, /*tp_str*/
  0, /*tp_getattro*/
  0, /*tp_setattro*/
  &__pyx_tp_as_buffer__TSNE, /*tp_as_buffer*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_10py_bh_tsne__TSNE, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_10py_bh_tsne__TSNE, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpy_bh_tsne(void); /*proto*/
PyMODINIT_FUNC initpy_bh_tsne(void)
#else
PyMODINIT_FUNC PyInit_py_bh_tsne(void); /*proto*/
PyMODINIT_FUNC PyInit_py_bh_tsne(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_py_bh_tsne(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("py_bh_tsne"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  if (__pyx_module_is_main_py_bh_tsne) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_10py_bh_tsne__TSNE) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "_TSNE", (PyObject *)&__pyx_type_10py_bh_tsne__TSNE) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10py_bh_tsne__TSNE = &__pyx_type_10py_bh_tsne__TSNE;
  /*--- Type import code ---*/
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init py_bh_tsne", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init py_bh_tsne");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
