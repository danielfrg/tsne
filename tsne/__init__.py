...
def bh_sne(data, pca_d=None, d=2, perplexity=30., theta=0.5,
           random_state=None, copy_data=False, miter=1000, sliter=250, msiter=250, m=0.5, fm=0.8):
    """
    ...
    tsne = BH_SNE()
    Y = tsne.run(X, N, X.shape[1], d, perplexity, theta, seed, miter, sliter, msiter, m, fm)
    return Y
